	...
	const slides = [
		{
			...
			description: '17 अप्रैल 2024 तारीख 8 बजे सैफूल सिंग कार्यसमिति समूह में पोस्ट कर दिया गया है',
				...
				{slides.map((slide, index) => (
					<div key={index} className="px-2">
						...
						>
							...
							{slide.description && <p className="text-xs leading-7 mt-8 md:mt-8">{slide.description}</p>}

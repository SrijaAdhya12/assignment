	...
	return (
		<div className="p-6 flex flex-col gap-4 mt-2">
			{options.map((option) => (
				<div
					key={option.name}
					className="flex gap-4 items-center justify-between p-2 bg-white rounded-md shadow-md border border-gray-100 hover:scale-105 transition-all duration-300"
				>
